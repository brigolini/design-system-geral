...
import type { AlmgComboboxProps, AlmgComboboxOption } from './AlCombobox.types';
...
export function AlmgCombobox<TFieldValues extends FieldValues = FieldValues>({
  name,
  form,
  options,
  label,
  ...
  className,
  'data-testid': testId,
}: AlmgComboboxProps<TFieldValues>) {
          ...
          <div style={{ position: 'relative', flex: 1 }}>
            ...
            <ul
              ...
              className={cn(
                ...
                isOpen && filteredOptions.length > 0 && almgComboboxClasses.menuOpen,
              )}
            >
              {isOpen &&
