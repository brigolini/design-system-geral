import{j as r}from"./classMap-B5ymgKpN.js";import{A as n}from"./AlButton-CMZaoz1i.js";import"./useAlLoading-VgDD9DiF.js";import"./AlSpinner-Cuh4XRh7.js";const O={title:"Atoms/AlButton",component:n,tags:["autodocs"],argTypes:{intent:{control:"select",options:["primary","secondary","danger","warning"]},loading:{control:"boolean"},disabled:{control:"boolean"},type:{control:"select",options:["button","submit","reset"]}}},e={args:{children:"Enviar",intent:"primary"}},a={args:{children:"Cancelar",intent:"secondary"}},t={args:{children:"Excluir",intent:"danger"}},s={args:{children:"Prossiga com cautela",intent:"warning"}},o={args:{children:"Salvando...",intent:"primary",loading:!0}},i={args:{children:"Desabilitado",intent:"primary",disabled:!0}},c={render:()=>r.jsxs("div",{style:{display:"flex",gap:"12px",flexWrap:"wrap"},children:[r.jsx(n,{intent:"primary",children:"Primary"}),r.jsx(n,{intent:"secondary",children:"Secondary"}),r.jsx(n,{intent:"danger",children:"Danger"}),r.jsx(n,{intent:"warning",children:"Warning"})]})};var d,l,p;e.parameters={...e.parameters,docs:{...(d=e.parameters)==null?void 0:d.docs,source:{originalSource:`{
  args: {
    children: 'Enviar',
    intent: 'primary'
  }
